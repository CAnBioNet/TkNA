...
aggregateConfigSpec = Config([
	TypedConfigItem("comparisonTreatments", list),
	TypedConfigItem("differenceMethod", str, default="mannwhitney"),
	TypedConfigItem("combineMethod", str, default="fisher"),
	TypedConfigItem("differenceCombinePValuesMethod", str, default="fisher"),
	TypedConfigItem("differenceCorrectPValuesMethod", str, default="fdr"),
	...
	TypedConfigItem("foldChangeType", str, default="median"),
